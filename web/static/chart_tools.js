(() => {
  ...
  function addMenu(){
    ...
    holder.querySelectorAll('[data-btool]').forEach(b=>b.addEventListener('click',()=>{
      ...
      if(t==='fullscreen'){if(document.fullscreenElement)document.exitFullscreen?.();else chart.requestFullscreen?.();return;}
    ...
    window.addEventListener('resize',redraw,{passive:true});redraw();return true;
  }
