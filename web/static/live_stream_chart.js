(() => {
  ...
  const S={c:null,symbol:'',interval:'1m',bars:[],timer:null,poll:null,clock:null,scaleMin:null,scaleMax:null,clockOffsetMs:0,marketTs:0};
  ...
  // BiQuote's timestamp is the market-data timestamp in UTC. Never invent a
  // candle timestamp from the browser clock when a market timestamp is absent.
  ...
  function updateLiveInfo(){
    ...
    const b=S.bars.at(-1), now=marketNow(), ms=MS();
    const p=b?.c;
