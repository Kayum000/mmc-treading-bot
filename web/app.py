...
def add_dashboard_assets(response):
    ...
    if '<a class="download-app"' in html and 'id="performance-compact"' not in html:
        html=html.replace('</head>',css+'</head>',1).replace('<a class="download-app"',markup+'<a class="download-app"',1).replace('</body>',script+'</body>',1)
